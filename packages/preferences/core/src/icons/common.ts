...
/**
 * 图标尺寸类型
 * @description 不包含 xs，xs 在 ExtendedIconSize 中定义
 */
export type IconSize = 'sm' | 'md' | 'lg' | 'xl';

/**
 * 图标尺寸映射 (px)
 * @description 从设计令牌获取，保持同步
 */
...
export const icons = {
  ...
  /** 帮助（问号） */
  helpCircle: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9 9a3 3 0 0 1 6 0c0 2-3 2-3 4"/><path d="M12 17h.01"/></svg>`,
  ...
  /** 侧边栏收起 */
  panelLeftClose: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/><path d="m16 15-3-3 3-3"/></svg>`,

  /** 深色侧边栏 - 左侧深色区块 */
  semiDarkSidebar: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/><rect x="3" y="3" width="6" height="18" rx="2" fill="currentColor" opacity="0.3"/></svg>`,

  /** 深色顶栏 - 顶部深色区块 */
  semiDarkHeader: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><rect x="3" y="3" width="18" height="6" rx="2" fill="currentColor" opacity="0.3"/></svg>`,
