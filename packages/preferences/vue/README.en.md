...
- **Composables**: `usePreferences`, `usePreferencesContext`, `usePreferencesCategory`, `useLayout`, `useTheme`, `useDebouncedValue`
...
5. Asset export: `defaultLockScreenBg`
6. Core re-exports: preference types, constants, and locales from `@admin-core/preferences`
...
- [@admin-core/preferences-react](../react/README.en.md) - React integration
